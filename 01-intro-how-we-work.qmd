...
Currently, we meet weekly for in person lab meetings, individual meetings with Emma, and our Shut Up and Write session.\
We use Googledocs to set agendas, record decisions made, and outline action items during meetings. Each lab member has their own google doc for their 1:1 meetings with Emma. Prior to each meeting, create your agenda for that meeting there.
