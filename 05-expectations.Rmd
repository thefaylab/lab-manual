...
A template for these, with thanks to [@duffy_ma](https://twitter.com/duffy_ma) can be found here.
...
Much like post-docs, research staff operate as independent and collaborative researchers on assigned projects. Given these are often working directly alongside Gavin, meetings will likely be more frequent than those with others in the lab. Weekly meetings should have clear agendas, and can often be used as collaborative working time to make progress on specific tasks. 
...
* Be flexible! Additional projects may be assigned to give additional funding. 
* Serve as a role model and go-to resource for other members of the lab

Research staff positions may be somewhat flexible in scope. For example, the position may include lab management responsibilities and leadership. If so, the expectations may extend further into scheduling meetings, reserving rooms and maintaing the lab manual, GitHub account, and Gmail/Google Drive account, etc. 
