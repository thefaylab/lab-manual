...
-   Start with identifying and listing the different datasets that you will be collecting or creating during your project. Remember that code, models, interviews, are also  types of research data.
    ...
    -   Do not restrict yourself to list only three types of datasets! Please provide a comprehensive list. If you would like to extend the list, you can do so by duplicating the provided slides.
