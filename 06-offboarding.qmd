...
To use the books available in the FayLab, first check the book's inventory (SMAST room 245). Then, create a request with Gavin mentioning the book you want to use and the time you wish to keep the book. Once the request is accepted, update our book availability GitHub link with your name, the book you requested and the required dates. After the procedure is completed, you can take the book from the library located in the FayLab, room 245. 
...
If you want to add other resources, such as photocopies or class summaries, add them to the shelf with all the necessary details such as class name, year, and a small description of the documents.
...
### Power points and scientific publications:

Power points presented by our lab members in symposiums, scientific meetings or dissertations are available in our [Google Drive folder](https://drive.google.com/drive/u/0/folders/17dGyBXX2PBKc2el3601bQgh1L5nEsuFy), as well as our list of scientific publications. If you need one or more of these resources remember to use proper citation of the authors to give them credit for their research, and add them to your reference list, ensure that you have the necessary permissions from the authors before using this material, including images, plots and text from publications. 
