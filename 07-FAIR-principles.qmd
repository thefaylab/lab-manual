...
Check out one of these datasets and evaluate how Findable, Accessible, Interoperable, Re-usable (FAIR) you think this data set is. If you have other examples to share, please do so in [GitHub Issue](link) \#
