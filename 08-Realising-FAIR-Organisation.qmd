...
## Data Organisation 
In the next video we will go through some recommended practices to help you organise the data of your project efficiently.
These recommended practices are using a good folder structure and an appropriate file naming convention to enhance the findability of the data in your directories.
...
The Turing Way: A Handbook for Reproducible Data Science (Version v0.0.4). Zenodo. http://doi.org/10.5281/zenodo.3233986
