...
- Develop a master CV to use as a catch all for everything you have done. This can be used to select what items you want to bring into specific CVs
- Label some sections as "Selected" (i.e., "Selected Presentations" or "Selected Publications"), and only chose the items you wish to showcase. These can be most recent, or focus on showing a diversity of publications/presentations/etc. You can also include a "9 of 15" for your selected works
