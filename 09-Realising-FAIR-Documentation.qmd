...
In the next video we will talk about different methods and tools you can use to document projects, datasets, and code.
We will also briefly talk about metadata.
...
5.  Pick a ReadMe file of someone else and read it. Provide feedback on the clarity of the ReadMe.
...
[TU Delft offers two different Electronic Lab Notebooks](https://www.tudelft.nl/en/library/research-data-management/r/manage/electronic-lab-note%20book), eLABjournal and Rspace.
