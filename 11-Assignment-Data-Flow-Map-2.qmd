...
Now that you learned about how to make your data more FAIR, you will have another look at the [Data Flow Map assignment](https://estherplomp.github.io/TNW-RDM-101/06-Assignment-Data-Flow-Map-1.html).
...
https://pbs.twimg.com/media/EdihtztWsAA9zaE?format=jpg&name=small
...
2. Will you use a metadata standard to document your data? 
    * You can use [FAIRsharing.org](https://fairsharing.org/) to check if a metadata standard exists for your discipline or type of data. 
    If one exists, you can provide the name and the link on FAIRsharing to it. 
3. What tools are helpful to generate/write the documentation needed? 
4. Additional remarks

## Step 4 - Reflect on the theme File formats 
Remember that **file formats** can enable or not interoperability and reusability. 
You already provided the data format in which you will collect/create the different datasets in your project (assignment 2). 
Go back to that information and think if you can convert those formats to an open file format that would increase interoperability if somebody would like to reuse the data. 
