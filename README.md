<p align="center"> 
   :sparkles: Welcome to the Marine Microbial Ecology Lab Manual! :sparkles: 
</p>


This ~~bookdown~~ Quarto book is intended to be used for **incoming, current, and outgoing** members of the MME lab group. If we missed anything, please let Emma Rocke (emma.rocke@uct.ac.za) know. You can also do a pull request and we will review the changes. 
